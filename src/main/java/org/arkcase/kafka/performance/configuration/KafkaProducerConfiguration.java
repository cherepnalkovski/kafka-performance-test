...
public class KafkaProducerConfiguration
{
    ...
    private Map<String, Object> getProperties()
    {
        ...
        // TODO: this configs should be tested in more details
            //configProps.put(ProducerConfig.REQUEST_TIMEOUT_MS_CONFIG, 100);
            configProps.put(ProducerConfig.BATCH_SIZE_CONFIG, 2000000);
            configProps.put(ProducerConfig.LINGER_MS_CONFIG, 100);
            //configProps.put(ProducerConfig.DELIVERY_TIMEOUT_MS_CONFIG, 1000);
            configProps.put(ProducerConfig.BUFFER_MEMORY_CONFIG, 3355443);
